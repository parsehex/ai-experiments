...
class CompletionOptions_Transformers(BaseModel):
	...
	max_time: int = Field(10,
	                      description='Maximum time for generation in seconds.')
	...
	temperature: float = Field(
	    1.0, description='Value used to module the next token probabilities.')
	top_k: int = Field(
	    50,
	    description=
	...
	repetition_penalty: float = Field(1.0,
	                                  description='Repetition penalty. 1 = Off')
