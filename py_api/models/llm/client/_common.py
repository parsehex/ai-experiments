...
class CompletionOptions(BaseModel):
	...
	min_p: float = Field(0.0,
	                     description='Minimum probability for top-p sampling.')
	...
	grammar: Optional[str] = Field(
	    None,
	    description='Grammar to use for constrained sampling. LlamaCpp only.')
	...
	temperature_last: Optional[bool] = Field(
	    False, description='Whether to use temperature last. Exllamav2 only.')
