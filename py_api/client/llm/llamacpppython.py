...
def LlamaCppCompletionConfig(prompt: str, max_tokens: int,
                             temperature: Union[int, float], top_p: int,
                             repetition_penalty: Union[int, float], seed: int,
...
class LLMClient_LlamaCppPython(LLMClient_Base):
	...
	def convert_options(
	    self, options: CompletionOptions) -> CompletionOptions_LlamaCppPython:
